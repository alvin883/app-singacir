...
const { addItem, reduceItem } = pedagang
...
class Landing extends Component {
  ...
  handleBackpress = () => {
    ...
    if (currentRouteName === "pedagang/landing") {
      if (isSheetOpen) {
        // Back one step
  ...
  gotoSearch = () => {
    ...
    navigation.navigate("pedagang/search-menu")
  }
  ...
  gotoDetail = () => {
    ...
    navigation.navigate("pedagang/detail", params)
  }

  gotoCheckout = () => {
    const { navigation } = this.props

    navigation.navigate("pedagang/checkout")
  }
