...
const Search = () => {
  ...
  function gotoWarungdetail({ id, title }) {
    console.log("warung/search - gotoWarungdetail: ", id, title)
    navigationServices.Navigate("warung/landing", { id, title })
  }
    ...
    <View style={styles.root}>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.wrapper}>
          <BlockList list={list} onItemPress={gotoWarungdetail} />
        </View>
      </ScrollView>
    </View>
  )
