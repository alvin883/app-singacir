...
// SET_REDUCER [warung/pedagang/warung]Reducer -> [addItem/reduceItem]
...
const warungReducer = (state = initState, action) => {
  let newState

  switch (action.type) {
    case actionName.WARUNG_ADD_ITEM:
    ...
    case actionName.WARUNG_REDUCE_ITEM:
    ...
    case actionName.WARUNG_SET_TIPS:
      newState = { ...state }
