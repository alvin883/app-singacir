...
const restoReducer = (state = initState, action) => {
  let newState

  switch (action.type) {
    case actionName.RESTO_ADD_ITEM:
    ...
    case actionName.RESTO_REDUCE_ITEM:
    ...
    case actionName.RESTO_SET_TIPS:
      newState = { ...state }
